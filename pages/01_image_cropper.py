...
min_height = 0 
max_height = len(img_arr)   # TODO: Replace None with the maximum height of the image using np.shape() function
  
min_width = 0
max_width = len(img_arr[0])    # TODO: Replace None with the maximum width of the image using np.shape() function   
